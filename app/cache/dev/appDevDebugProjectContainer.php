...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fos_twitter.anywhere.helper' => 'getFosTwitter_Anywhere_HelperService',
            'fos_twitter.anywhere.twig' => 'getFosTwitter_Anywhere_TwigService',
            'fos_twitter.api' => 'getFosTwitter_ApiService',
            'fos_twitter.service' => 'getFosTwitter_ServiceService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/STATION/wamp/www/Explee/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/STATION/wamp/www/Explee/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/STATION/wamp/www/Explee/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/STATION/wamp/www/Explee/app/Resources');
    ...
    protected function getDebug_Templating_Engine_PhpService()
    {
        ...
        $instance->setHelpers(array('slots' => 'templating.helper.slots', 'assets' => 'templating.helper.assets', 'request' => 'templating.helper.request', 'session' => 'templating.helper.session', 'router' => 'templating.helper.router', 'actions' => 'templating.helper.actions', 'code' => 'templating.helper.code', 'translator' => 'templating.helper.translator', 'form' => 'templating.helper.form', 'stopwatch' => 'templating.helper.stopwatch', 'logout_url' => 'templating.helper.logout_url', 'security' => 'templating.helper.security', 'assetic' => 'assetic.helper.dynamic', 'twitter_anywhere' => 'fos_twitter.anywhere.helper'));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_62cb9df305ebb767ebf5512596d0ae73050dc93f5d0119c651cc30af67aed362');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_62cb9df305ebb767ebf5512596d0ae73050dc93f5d0119c651cc30af67aed362');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_62cb9df305ebb767ebf5512596d0ae73050dc93f5d0119c651cc30af67aed362');
        ...
        $d->setProxyDir('D:/STATION/wamp/www/Explee/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/STATION/wamp/www/Explee/app/Resources');
    }
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(), 'D:/STATION/wamp/www/Explee/app/cache/dev', array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'AsseticBundle' => 'Symfony\\Bundle\\AsseticBundle\\AsseticBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'ExpleeTestBundle' => 'Explee\\TestBundle\\ExpleeTestBundle', 'FOSTwitterBundle' => 'FOS\\TwitterBundle\\FOSTwitterBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'AcmeDemoBundle' => 'Acme\\DemoBundle\\AcmeDemoBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle'));
    }
    ...
    {
        return $this->services['fos_twitter.anywhere.helper'] = new \FOS\TwitterBundle\Templating\Helper\TwitterAnywhereHelper($this->get('templating'), 'sSYdSX9pF5kC0HwUzwLow', '1');
    }
    ...
    {
        require_once 'D:/STATION/wamp/www/Explee/app/../vendor/twitteroauth/twitteroauth/twitteroauth.php';

        return $this->services['fos_twitter.api'] = new \TwitterOAuth('sSYdSX9pF5kC0HwUzwLow', 'OuHKASktxUzuqbcxJUOTlF5X8i8qX9ntBpeUB1mHTLg', NULL, NULL);
    }
    ...
    {
        return $this->services['fos_twitter.service'] = new \FOS\TwitterBundle\Services\Twitter($this->get('fos_twitter.api'), $this->get('session'), 'http://www.example.com/login_check');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/STATION/wamp/www/Explee/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/STATION/wamp/www/Explee/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/STATION/wamp/www/Explee/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/STATION/wamp/www/Explee/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('/.*');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/STATION/wamp/www/Explee/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/STATION/wamp/www/Explee/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/STATION/wamp/www/Explee/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/STATION/wamp/www/Explee/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/STATION/wamp/www/Explee/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/STATION/wamp/www/Explee/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\src\\Explee\\TestBundle/Resources/views', 'ExpleeTest');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\vendor\\bundles\\FOS\\TwitterBundle/Resources/views', 'FOSTwitter');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('D:/STATION/wamp/www/Explee/app/Resources/views');
        $instance->addPath('D:\\STATION\\wamp\\www\\Explee\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/STATION/wamp/www/Explee/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/STATION/wamp/www/Explee/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['router.request_context'] = new \Symfony\Component\Routing\RequestContext('http://localhost/Explee/web/app_dev.php', 'GET', 'localhost', 'http', 80, 443);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/STATION/wamp/www/Explee/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\STATION\\wamp\\www\\Explee\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/STATION/wamp/www/Explee/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/STATION/wamp/www/Explee/app/cache/dev',
            'kernel.logs_dir' => 'D:/STATION/wamp/www/Explee/app/logs',
            'kernel.bundles' => array(
                ...
                'ExpleeTestBundle' => 'Explee\\TestBundle\\ExpleeTestBundle',
            ...
            'router.request_context.base_url' => 'http://localhost/Explee/web/app_dev.php',
            ...
            'debug.container.dump' => 'D:/STATION/wamp/www/Explee/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/STATION/wamp/www/Explee/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\STATION\\wamp\\www\\Explee\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/STATION/wamp/www/Explee/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/STATION/wamp/www/Explee/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/STATION/wamp/www/Explee/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/STATION/wamp/www/Explee/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/STATION/wamp/www/Explee/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/STATION/wamp/www/Explee/app/../web',
            'assetic.write_to' => 'D:/STATION/wamp/www/Explee/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'D:/STATION/wamp/www/Explee/app/cache/dev/doctrine/orm/Proxies',
            ...
            'fos_twitter.file' => 'D:/STATION/wamp/www/Explee/app/../vendor/twitteroauth/twitteroauth/twitteroauth.php',
            'fos_twitter.consumer_key' => 'sSYdSX9pF5kC0HwUzwLow',
            'fos_twitter.consumer_secret' => 'OuHKASktxUzuqbcxJUOTlF5X8i8qX9ntBpeUB1mHTLg',
            'fos_twitter.access_token' => NULL,
            'fos_twitter.access_token_secret' => NULL,
            'fos_twitter.callback_url' => 'http://www.example.com/login_check',
